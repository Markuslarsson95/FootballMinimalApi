...
namespace WebApp.Endpoints
{
    public class ClubEndpoints : ICarterModule
    {
        ...
        public static async Task<IResult> GetAllClubs(FootballDbContext db)
        {
            try
            {
        ...
        public static async Task<IResult> GetClubById(int id, FootballDbContext db)
        {
            try
            {
        ...
        public static async Task<IResult> CreateClub(CreateClubDto createClubDto, FootballDbContext db)
        {
        ...
        public static async Task<IResult> UpdateClub(int id, UpdateClubDto updateClubDto, FootballDbContext db)
        {
            try
            {
        ...
        public static async Task<IResult> RemoveClub(int id, FootballDbContext db)
        {
            try
            {
                var club = await db.Clubs
